                            ...
                            <Link href={`/articulos/${post.slug}`} className="group block h-full">
                                <article className="flex flex-col h-full border border-armor-light bg-paper-dark/30 hover:border-blood/50 transition-all duration-500 overflow-hidden glow-red-hover group">
                                    ...
                                    <div className="p-6 flex-grow flex flex-col">
                                        ...
                                        <h4 className="font-heavy text-xl leading-tight mb-4 text-white group-hover:text-blood transition-colors uppercase">
                                            {post.title}
                                        </h4>
                                        ...
                                        <div className="mt-6 pt-4 border-t border-armor-light flex justify-between items-center">
                                            ...
                                            <ArrowRight size={14} className="text-armor group-hover:text-blood transition-colors group-hover:translate-x-1 transition-transform" />
                                        </div>
                                    </div>
                                </article>
                            </Link>
